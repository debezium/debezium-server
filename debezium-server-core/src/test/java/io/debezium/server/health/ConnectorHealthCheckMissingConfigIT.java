...
@QuarkusTest
@TestProfile(MissingConfigProfile.class)
...
public class ConnectorHealthCheckMissingConfigIT {
    ...
    @Test
    void livenessReportsDownWhenConfigIsMissing() {
    ...
    @Test
    void readinessReportsDownWhenConfigIsMissing() {
        Awaitility.await().atMost(Duration.ofSeconds(TestConfigSource.waitForSeconds()))
                .untilAsserted(() -> given()
